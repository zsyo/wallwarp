...
use crate::ui::style::{BUTTON_SPACING, INPUT_PADDING, TEXT_INPUT_SIZE};
...
/// 创建图源配置区块
///
/// 当前管理 Wallhaven API 密钥；预留多在线图源管理入口。
pub fn create_sources_section<'a>(app: &'a App) -> Element<'a, AppMessage> {
    ...
    let rows = vec![
        super::create_setting_row(
            ...
            Some(app.i18n.t("settings.wallhaven-api-key-desc")),
            row![
                api_key_input,
        ...
        super::create_setting_row(
            app.i18n.t("settings.more-sources"),
            Some(app.i18n.t("settings.more-sources-desc")),
            super::create_coming_soon_badge(
                app.i18n.t("settings.coming-soon"),
                theme_colors,
            ),
            theme_colors,
        ),
    ...
    super::create_config_section(
        "\u{F42B}", // images
        app.i18n.t("settings.category-sources"),
        rows,
        &app.theme_config,
    )
}
