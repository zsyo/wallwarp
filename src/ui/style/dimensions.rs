...
/// 标题栏高度
pub const TITLE_BAR_HEIGHT: Length = Length::Fixed(32.0);

/// 标题栏按钮大小
pub const TITLE_BAR_BUTTON_SIZE: f32 = 32.0;

/// 标题栏按钮间距
pub const TITLE_BAR_BUTTON_SPACING: f32 = 8.0;

/// 标题栏内边距
pub const TITLE_BAR_PADDING: [u16; 2] = [8, 12];

/// 标题栏标题文字大小
pub const TITLE_BAR_TITLE_SIZE: f32 = 13.0;
