...
pub(in crate::ui::local) use {
    ...
    loaded_wallpaper::create_loaded_wallpaper, loading_placeholder::create_loading_placeholder,
    modal_loading_placeholder::create_modal_loading_placeholder, model::create_model,
};
